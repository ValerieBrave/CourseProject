...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(116, "lex: Недопустимое значение литерала"),ERROR_ENTRY(117, "lex: Превышена максимальная длина строки"),ERROR_ENTRY(118, "lex: Невозможно определить тип данных"),
