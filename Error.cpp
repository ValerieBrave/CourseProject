...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] = //таблица ошибок
	{
		...
		ERROR_ENTRY(600, "sem: Неправильная структура программы"),
		ERROR_ENTRY(601, "sem: Ошибочный оператор"),
		ERROR_ENTRY(602, "sem: Ошибка в выражении"),
		ERROR_ENTRY(603, "sem: Ошибка в записи выражения"),
		ERROR_ENTRY(604, "sem: Ошибка в передаче формальных параметров"),
		ERROR_ENTRY(605, "sem: Ошибка в передаче фактических параметров"),
		ERROR_ENTRY(606, "sem: Ошибка в объявлении функции"),
		ERROR_ENTRY(607, "sem: Синтаксический анализ выполнен с ошибкой"),
